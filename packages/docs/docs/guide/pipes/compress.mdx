...
| ------ | ----------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------- |
| jpg    | `object \| false \| 'skip'` | Any settings supported by [sharp jpeg](https://sharp.pixelplumbing.com/api-output#jpeg). If `skip` is specified, the original image will not be included in the output. |
| png    | `object \| false \| 'skip'` | Any settings supported by [sharp png](https://sharp.pixelplumbing.com/api-output#png). If `skip` is specified, the original image will not be included in the output. |
