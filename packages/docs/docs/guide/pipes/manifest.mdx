...
| srcSortOptions   | `object`, `(assetsSrc: PixiManifestEntry['src']) => PixiManifestEntry['src']` | A custom sort function or object configuration to sort the source order. <br />Defaults to `{ order: 'descending' }`.                                                                                                                                                              |
