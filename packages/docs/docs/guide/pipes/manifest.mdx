...
When using the [TexturePacker plugin](/docs/guide/pipes/texturepacker), you should use the `texturePackerManifestMod` plugin to augment the manifest file. This ensures that the correct file size is used for the texture atlas files.
