...
| texturePacker.autodetectAnimations   | `boolean`                                  | Whether to group sprites with numeric suffixes as animations.<br />Defaults to `true`.                                                                                                          |
...
| resolutionOptions.template           | `string`, `(resolution: number) => string` | If a string:<br />a template for denoting the resolution of the images.<br /><br />If a function:<br />a custom formatter for denoting the resolution of images.<br /><br />Defaults to `@%%x`. |
